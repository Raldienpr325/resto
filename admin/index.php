...
<head>
  ...
  <link rel="icon" href="../images/icon.png">
	<title>Sielvia Catering Admin - Login</title>
...
<div class="container">
  <div class="info">
    <h1>Administration </h1><span> login Akun</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    ...
    <input type="text" placeholder="alamat email"  name="cr_email"/>
	 <input type="password" placeholder="password"  name="cr_pass"/>
	  <input type="password" placeholder="Ulangi password"  name="cr_cpass"/>
	  <input type="password" placeholder="Unique-Code"  name="code"/>
   <input type="submit"  name="submit1" value="Buat Akun" />
    <p class="message">Punya akun? <a href="#">Login</a></p>
  </form>
